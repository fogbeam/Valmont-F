		...
		<div id="page-body" role="main">
			...
			<p>
				<g:each in="${results}" var="result">
					...
					<div style="float:left;width:200px;background-color:#F8F8F8;min-height:100px;margin-left:20px;">
						
						"A" Results:
						
						<ul>
						<g:each in="${result.aTermDocs}" var="doc">
							<li><a target="_blank" href="http://www.ncbi.nlm.nih.gov/pubmed?term=${doc.uid}[uid]&cmd=DetailsSearch">${doc.uid}</a></li>
						</g:each>
						</ul>
